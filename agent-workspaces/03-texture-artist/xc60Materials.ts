...
import type { XC60Build } from "../02-cad-expert/xc60Geometry";
...
const REAR_EMISSIVE_BASE = 1.0;
const REAR_EMISSIVE_SPAN = 3.2; // total at k=1: BASE + SPAN = 4.2 (rear dominates)
